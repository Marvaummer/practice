...
import 'package:practice/TodoApp/widgets/todo_item.dart';
...
class _HomeTodoState extends State<HomeTodo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: COLORS.tdBGColor,
      appBar:_buildAppbar(),
...
void _runFilter(String enteredKeyword){
      ...
      child: TextField(
       onChanged: (value)=>_runFilter(value),
        decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.search,color: COLORS.tdBlack,size: 20,),
  ...
  AppBar _buildAppbar(){
    return AppBar(
      ...
      children: [
        Icon(Icons.menu,color: COLORS.tdBlack,size: 30,),
